 ...
 * 大部分应用程序都实现的  SPI 接口。
 *
 * 除了应用程序上下文接口中的应用程序上下文客户端方法之外，还提供配置应用程序上下文的工具
 *
