...
public class HandlerMethod {
	...
	/**
	 * 相应的状态码，即 {@link ResponseStatus#code()}
	 */
	@Nullable
	private HttpStatus responseStatus;

	/**
	 * 响应的状态原因，即 {@link ResponseStatus#reason()}
	 */
	@Nullable
	 ...
	 * <p>
	 * 仅构造方法中传入的 HandlerMethod 类型的参数适用，例如 {@link HandlerMethod#HandlerMethod(HandlerMethod)}
	 */
	@Nullable
	...
	public HandlerMethod(Object bean, Method method) {
		...
		/**
		 * 初始化 responseStatus、responseStatusReason
		 */
	 ...
	 * <p>
	 * 根据给定的 Bean 实例，方法名称以及参数类型创建一个 HandlerMethod 实例
	 *
	 ...
	 * <p>
	 * 根据给定的 bean 名称、方法名称、 BeanFactory 创建一个新的示例
	 * 这个方法可能再 {@link #createWithResolvedBean()} 使用之后，重新创建初始化 bean
	 */
